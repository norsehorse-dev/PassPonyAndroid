...
// repo has none yet. See README's build section for the pinned SHA and how
// to re-pin once a real release exists. Included directly as a subproject
// (not via includeBuild dependency substitution) since the module publishes
// no group/version of its own — it is meant to be consumed as source, the
// way this submodule pattern is used.
include(":pgponycore")
